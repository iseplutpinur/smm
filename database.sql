...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2022 at 12:54 PM
...
INSERT INTO `catatan` (`id`, `username`, `note`, `waktu`) VALUES
(1, 'demo', 'Kamu telah melakukan aktifitas Login dengan Ip ::1', '2022-11-20 08:20:09'),
(2, 'demo', 'Kamu telah melakukan aktifitas Login dengan Ip ::1', '2022-11-20 08:27:07');
...
--
-- Dumping data for table `deposits_history`
--
...
--
-- Table structure for table `deposits_method`
--
...
--
-- Dumping data for table `deposits_method`
--
...
--
-- Table structure for table `orders_diamond`
--
...
--
-- Dumping data for table `orders_diamond`
--
...
--
-- Table structure for table `services_diamond`
--
...
--
-- Dumping data for table `services_diamond`
--
...
--
-- Table structure for table `services_pulsa_cat`
--
...
--
-- Table structure for table `services_token`
--
...
--
-- Dumping data for table `services_token`
--
...
--
-- Indexes for table `deposits_method`
--
...
--
-- Indexes for table `orders_diamond`
--
...
--
-- Indexes for table `services_diamond`
--
...
--
-- Indexes for table `services_pulsa_cat`
--
ALTER TABLE `services_pulsa_cat`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `services_token`
--
...
--
-- AUTO_INCREMENT for table `deposits_method`
--
ALTER TABLE `deposits_method`
...
--
-- AUTO_INCREMENT for table `service_dog`
--
ALTER TABLE `service_dog`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
